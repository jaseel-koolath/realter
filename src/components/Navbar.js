...
function Navbar() {
  ...
  return (
    <div className="flex items-center justify-between bg-white p-2 mx-auto whitespace-nowrap max-w-[95vw] lg:max-w-[1280px] ">
      {/* Left Menu */}
      ...
      <div className="hidden lg:flex justify-between px-5 ">
        <div className="flex text-sm">
          {navItems.map((item) => (
            <button className="border-b-2 border-b-transparent px-2 focus:border-b-red-500 hover:border-b-red-500 ">
              {item.title}
            </button>
          ))}
        </div>
